# Let us first define two pytorch modules for autoregressive image generation.
# One uses a recurrent formulation that accepts one input at a time and the other
# similar to the default PyTorch implementation accepts the whole sequence.

# In both cases the model is simply wrapping a transformer with an input embedding
# layer and a prediction layer. This becomes apparent upon reading the simple forward() method.
